...
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
    ...
    <body>
        <div class="flex-center position-ref full-height">
                ...
                <input type="text" placeholder="NAMA" name="nama" class="nama">
                ...
                <table id="customers" style="width: 1000px;">
                    ...
                    @foreach($data as $el)
                        ...
                        <tr>
                            ...
                            <td>{{$el->mengajar}}</td>
                            <td>
                                <button class="button" style="background-color: yellow;" onclick="edit('{{$el->id}}','{{$el->nama}}','{{$el->mengajar}}')">edit</button>
                                <button class="button" style="background-color: red;" onclick="hapus({{$el->id}})">hapus</button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                    ...
                    $.each(data.hasil, function(index) {
                            ...
                            $('.drop_here').append(
                                '<tr>'+
                                    ...
                                    '<td><button class="button" style="background-color: yellow;" onclick="edit("'+data.hasil[index].id+'","'+data.hasil[index].nama+'","'+data.hasil[index].mengajar+'")">edit</button><button class="button" style="background-color: red;" onclick="hapus('+data.hasil[index].id+')">hapus</button></td>'+
                                '</tr>'
                            );
                        });
                }
